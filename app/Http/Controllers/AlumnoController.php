...
class AlumnoController extends Controller
{
    function consultar6AMP(){
        $alumnos = x6AMPAlumno::paginate(12);
    ...
    function consultar2AMCO(){
        $alumnos = x2AMCOAlumno::paginate(12);
    ...
    function consultar2AME(){
        $alumnos = x2AMEAlumno::paginate(12);
    ...
    function consultar4AMC(){
        $alumnos = x4AMCAlumno::paginate(12);
    ...
    function consultar6AMO(){
        $alumnos = x6AMOAlumno::paginate(12);
