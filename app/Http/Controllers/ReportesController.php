...
class ReportesController extends Controller
{
    ...
    function consultar2AMCO(){
        $reportes = reporte::where('grupotabla', 'x2amcoalumnos')->paginate(12);
        $grupo = '2AMCO';
        return view('reportes.tablaReportes', compact('reportes','grupo'));
    }
    function consultar6AMP(){
        $reportes = reporte::where('grupotabla', 'x6ampalumnos')->paginate(12);
        $grupo = '6AMP';
        return view('reportes.tablaReportes', compact('reportes','grupo'));
    }
    function consultar4AMC(){
        $reportes = reporte::where('grupotabla', 'x4amcalumnos')->paginate(12);
        $grupo = '4AMC';
        return view('reportes.tablaReportes', compact('reportes','grupo'));
    }
    function consultar6AMO(){
        $reportes = reporte::where('grupotabla', 'x6amoalumnos')->paginate(12);
        $grupo = '6AMO';
        return view('reportes.tablaReportes', compact('reportes','grupo'));
    }
    function consultar2AME(){
        $reportes = reporte::where('grupotabla', 'x2amealumnos')->paginate(12);
        $grupo = '2AME';
        return view('reportes.tablaReportes', compact('reportes','grupo'));
    }
}
